      ...
      <head-search @hander-search="search">
        <div class="cakeNews-searchContent fx">
          ...
          <p class="fx">
            ...
            <product-type-select @getProductType="getProductType"  v-bind:provinceId="provinceId" v-bind:cityId="cityId" v-bind:productType="this.productCategoryType"></product-type-select>
          </p>
          <p>
            <span>是否首页商品：</span>
